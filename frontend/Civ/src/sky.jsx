// for stars background in non Globe pages
...
export default function Stars(){
  ...
  useEffect(() =>{
    ...
    // STARS BACKGROUND, geometry and material and positioning
    ...
    const starMaterial = new THREE.PointsMaterial({color: 0xffffff,size: 1,sizeAttenuation: true,transparent: true});
    ...
    // star layers of far and medium distance stars
